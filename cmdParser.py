...
class cmdParser(object):
    # Members
    #
    txtColours_ = color.colorizer(colored = False)
    ...
    def parse(self):
        ...
        parser.add_argument(consts.ARG_MODE_S, consts.ARG_MODE, help = consts.COMMENT_MODE, required = False, nargs = 1, default = [consts.MODE_AUTO], type=str, choices=[consts.MODE_AUTO, consts.MODE_CONSOLE, consts.MODE_PYGAME])
